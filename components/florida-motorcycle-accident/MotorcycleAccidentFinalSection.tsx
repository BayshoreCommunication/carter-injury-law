...
export default function MotorcycleAccidentFinalSection() {
  return (
    <div className="min-h-screen pt-8 px-4 md:px-8 mb-8">
      <div className="max-w-5xl mx-auto space-y-6 text-lg text-slate-600 leading-relaxed">
        ...
        <p>
          ...
          different story, and every accident has unique circumstances. We take
          the time to understand your specific needs and goals. Whether you want
          to settle quickly to move on with your life or you are prepared for a
          long court battle to achieve maximum justice, we tailor our strategy
        ...
        <p>
          ...
          unthinkable happens, we are prepared to be the shield and sword for
          our clients.
        </p>
        ...
        <p>
          ...
          from the initial consultation to the final disbursement of your
          settlement.
        </p>

        {/* H2 */}
        <h2 className="text-2xl font-bold text-slate-900 pt-8">
          Immediate Steps to Take If You Are Injured in a Motorcycle Accident
          Today
        </h2>
        ...
        <p>
          ...
          foundational piece of evidence in your case. If you are physically
          able, gather the contact information of any witnesses who saw the
          crash.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Keep all medical records; documentation is the key to your
            compensation.
          </li>
          <li>
            Track your expenses. Every bill, no matter how small, counts toward
            your claim.
          </li>
        </ul>
        ...
        <p>
          ...
          your injuries are not as severe as you claim. Keep a journal of your
        ...
        <p>
          ...
          everything they can to protect their legal rights.
        </p>

        {/* H2 */}
        <h2 className="text-2xl font-bold text-slate-900 pt-8">
          Why Our Aggressive Lawyers for Motorcycle Accident Victims Never
          Settle for Less
        </h2>
        ...
        <p>
          ...
          them to those dates. If they refuse to negotiate in good faith, we are
        ...
        <p>
          ...
          of legal protection. Our team is constantly refining our skills and
          staying up-to-date on the latest forensic techniques and legal
          precedents.
        </p>
        ...
        <p>
          ...
          who want a firm that will fight for every dollar they are owed.
        </p>
        ...
        <p>
          ...
          the very best and that your future is secure.
        </p>

        {/* H2 */}
        <h2 className="text-2xl font-bold text-slate-900 pt-8">
          Advanced Tactics to Resolve Complex Motorcycle Accident Claims and
          Legal Hurdles
        </h2>
        ...
        <p>
          ...
          vehicle, the stakes are even higher. These companies have their own
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Even if the other driver doesn't have insurance, we can still find a
            way to get you paid.
          </li>
          <li>We look into hit-and-run cases to find the person who did it.</li>
        </ul>
        ...
        <p>
          ...
          recovery. Our firm thrives on solving the difficult problems that
          arise in modern traffic litigation.
        </p>

        {/* H2 */}
        <h2 className="text-2xl font-bold text-slate-900 pt-8">
          The Proven Reputation of Our Trusted Attorneys for Motorcycle
        ...
        <p>
          ...
          consistent communication. We make it a point to return phone calls
        ...
        <p>
          ...
          the firm that Florida riders recommend to their friends and family.
        </p>
        {/* CTA Section  */}
        ...
        {/* H2 */}
        <h2 className="text-2xl font-bold text-slate-900 pt-8">
          Our Firm’s Dedicated Mission to Lower the Total Number of Motorcycle
        ...
        <p>
          ...
          reckless driving has consequences. We also support legislative efforts
        ...
        <p>
          ...
          922-0228 or visit our Tampa office for a free, no-obligation case
          review.
        </p>
