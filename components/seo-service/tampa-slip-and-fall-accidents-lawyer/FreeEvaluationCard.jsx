...
const FreeEvaluationCard = ({
  title = "Schedule Your Free, Confidential Tampa Slip and Fall Accident Case Evaluation Today",
  subtitle = "Hazardous conditions get fixed fast, and surveillance footage gets overwritten within hours. Don't wait until the physical evidence is gone and the property owner's version of events is the only one on record.",
}) => {
