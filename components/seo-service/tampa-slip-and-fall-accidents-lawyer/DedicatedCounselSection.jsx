      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8">
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 text-center space-y-6">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-[40px] font-extrabold text-secondary tracking-tight leading-tight">
            Dedicated Legal Representation for Tampa Slip and Fall Injury Victims
          </h2>
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed font-medium text-left md:text-center">
            David Carter built this firm around one idea. Clients should work with their actual attorney, not get passed around to support staff who may have never read their file. When you hire Carter Injury Law, David Carter handles your case himself. You get his number. He takes your calls. You always know where things stand. The firm works on contingency, meaning there are no upfront costs and no attorney fees unless compensation is actually recovered on your behalf. That arrangement exists so every injured Tampa resident can access the same quality of tampa slip and fall accidents lawyer representation regardless of their financial situation during recovery. Settling a case isn't the finish line. Getting a result that genuinely reflects what the injury cost you is.
          </p>
