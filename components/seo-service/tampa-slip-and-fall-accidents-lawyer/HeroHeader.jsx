...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "tampa-slip-and-fall-accidents-lawyer").filePath,
  lawyerLeft = getSeoImage("carter.png", "tampa-slip-and-fall-accidents-lawyer").filePath,
  
  titlePart1 = "Tampa Slip and Fall Accidents Lawyer,",
  titlePart2 = "Protecting Injury Victims After Serious Falls",
  subtitle = "A fall can cause a variety of injuries, medical expenses, and questions about who was to blame. Our tampa slip and fall accidents lawyer can help you when you have fallen as a result of the unsafe conditions of another person's property. Tampa and Hillsborough County attorney David Carter has been defending injured clients for over 10 years. Carter Injury Law has represented hundreds of personal injury clients and consistently pursued compensation that reflects the true cost of each client's injuries. If you are injured in a slip and fall, Carter Injury Law can assess your claim and help you pursue the compensation you may be entitled to receive.",
}) => {
  return (
    <section 
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col justify-center pt-2 pb-10 lg:py-20 pr-0 lg:pr-10 order-2 lg:order-1">
            <div className="space-y-6">
              ...
              <motion.h1 
                ...
                className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl xl:text-[48px] font-extrabold text-white lg:text-secondary leading-[1.1] tracking-tight animate-none break-words"
              >
                {titlePart1} <br />
        ...
        >
          ...
          <div className="flex items-start gap-4 lg:px-6 hover:translate-x-1 transition-transform duration-300">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs sm:text-sm mt-1.5 leading-normal">
                Local lawyers. Local results. Serving Hillsborough County.
              </p>
            </div>
          </div>
