...
const HeroHeader = ({
  ...
  subtitle = "There are few things that can match the feeling of freedom that can be experienced on a motorcycle. However open they are, if the traffic gets bad, they're up a creek without a paddle. Just one second of inattention from a driver can result in broken bones, road rash or so much more. Injured riders are seldom made to easily receive compensation from insurance companies. Our Tampa motorcycle accidents lawyer will be on your side when you are out on a motorcycle and in the aftermath of an accident with another motorist. We strive to get negligent drivers to cover their share of the damages and to seek all of the damages that a serious crash deserves.",
}) => {
  return (
    <section 
        ...
        >
          ...
          <div className="flex items-start gap-4 lg:px-6 hover:translate-x-1 transition-transform duration-300">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs sm:text-sm mt-1.5 leading-normal">
                Local lawyers. Local results. Proudly serving Hillsborough County.
              </p>
            </div>
          </div>
        </motion.div>
