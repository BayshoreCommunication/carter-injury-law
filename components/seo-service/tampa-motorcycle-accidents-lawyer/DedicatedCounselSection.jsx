...
const features = [
  {
    number: "01",
    title: "Lifting Physical & Financial Burdens",
    body: "We help lift that burden by managing every single legal detail of your complex personal injury claim.",
  },
  {
    number: "02",
    title: "Direct Attorney Access",
    body: "You get direct access to your attorney from your first meeting until we reach a final resolution.",
  },
  {
    number: "03",
    title: "Focused Legal Strategy",
    body: "We provide clear updates and build a legal strategy focused on your unique injuries and specific needs.",
  },
];
    ...
    <section className="w-full bg-white py-0 overflow-hidden">
      <div className="max-w-[1320px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[580px]">
          ...
          >
            <Image
              src={getSeoImage("dedicated-counsel.png", "tampa-motorcycle-accidents-lawyer").filePath} alt={getSeoImage("dedicated-counsel.png", "tampa-motorcycle-accidents-lawyer").altText} title={getSeoImage("dedicated-counsel.png", "tampa-motorcycle-accidents-lawyer").title}
              fill
          ...
          <div className="flex flex-col justify-center px-8 md:px-14 lg:px-16 py-14 lg:py-20 bg-[#faf9f6]">
            ...
            >
              Dedicated Legal Counsel for Tampa Motorcycle Accident Victims
            </motion.h2>
            ...
            <motion.p 
              ...
              className="text-gray-600 text-sm md:text-base leading-relaxed mb-8 max-w-xl font-medium"
            >
              As a trusted Tampa motorcycle accidents lawyer, Carter Injury Law treats every Tampa motorcycle accident case with the genuine care it requires. Our attorneys know how a crash burdens riders and their families with deep physical and financial pain. We help lift that burden by managing every single legal detail of your complex personal injury claim. You get direct access to your attorney from your first meeting until we reach a final resolution. We provide clear updates and build a legal strategy focused on your unique injuries and specific needs.
            </motion.p>
