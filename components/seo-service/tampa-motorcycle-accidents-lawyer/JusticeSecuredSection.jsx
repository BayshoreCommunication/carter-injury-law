  ...
  return (
    <section className="w-full bg-secondary py-16 text-white relative overflow-hidden">
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10 text-center">
        ...
        >
          Justice Secured for Tampa Motorcycle Accident Victims We Have Represented
        </motion.p>
        ...
        >
          Here is a glimpse of the commitment we bring to every claim. Our firm has recovered significant compensation for injured motorcyclists and other accident victims throughout the Tampa Bay area.
        </motion.p>
