...
const offices = [
  {
    ...
    embedSrc: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3523.5123456789!2d-82.46456789!3d27.97123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88c2c4b5a6d7e8f9%3A0x1a2b3c4d5e6f7a8b!2s3114%20N%20Boulevard%2C%20Tampa%2C%20FL%2033603!5e0!3m2!1sen!2sus!4v1784709237604!5m2!1sen!2sus",
  },
  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6 mb-6">
          ...
          <div className="rounded-[20px] overflow-hidden border border-gray-100 shadow-sm w-full h-[380px] sm:h-[460px] lg:h-auto lg:min-h-[320px]">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3523.5123456789!2d-82.46456789!3d27.97123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88c2c4b5a6d7e8f9%3A0x1a2b3c4d5e6f7a8b!2s3114%20N%20Boulevard%2C%20Tampa%2C%20FL%2033603!5e0!3m2!1sen!2sus!4v1784709237604!5m2!1sen!2sus"
              width="100%"
              height="100%"
        ...
        <div className="bg-secondary rounded-[20px] p-7 md:p-9 flex flex-col md:flex-row items-center justify-between gap-6 shadow-lg mt-8">
          <div className="flex items-center gap-5">
            ...
            <p className="text-white font-bold text-sm md:text-base leading-snug max-w-lg">
              Wherever in Tampa or Hillsborough County you are located, we are ready to sit down and start your claim.
            </p>
          </div>
