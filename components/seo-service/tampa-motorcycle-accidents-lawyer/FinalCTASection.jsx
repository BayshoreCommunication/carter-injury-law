...
import { Phone, Calendar, ArrowRight, Globe, MapPin } from "lucide-react";
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
            ...
            >
              Secure Committed Legal Advocacy <br />
            ...
            <p className="text-white/70 text-base md:text-[17px] leading-relaxed mb-8 font-medium">
              Every day that passes without legal guidance is a day insurance companies use to their advantage. Speak with a Tampa motorcycle accidents lawyer today for a free confidential consultation.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-white/10 max-w-xl">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-primary text-sm font-bold">(813) 922-0228</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold text-sm mt-0.5">801 W. Bay Dr., Suite 229, Largo, FL 33770 (By Appointment)</p>
                  <p className="text-primary text-sm font-bold">(727) 955-1922</p>
                </div>
              </div>
            </div>
          ...
          <div className="col-span-12 lg:col-span-5 relative flex items-center justify-center">
            ...
            >
              ...
              >
                ...
                <div>
                  <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Tampa Office Phone</p>
