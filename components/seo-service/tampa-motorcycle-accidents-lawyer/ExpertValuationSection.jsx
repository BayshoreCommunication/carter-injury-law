...
const checks = [
  "Comprehensive investigation of crash physics and road hazards.",
  "Countering insurer blame-shifting and comparative fault arguments.",
  "Documenting medical care, future surgeries, and rehabilitation needs.",
  "Preparing every case for trial to force maximum accountability.",
];
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
            ...
            >
              How a Tampa motorcycle accidents lawyer Turns Tragic Accidents <br />
            ...
            <div className="space-y-6 text-white/80 text-sm md:text-base leading-relaxed font-medium">
              <p>
                In an instant, a serious motorcycle accident can turn a person's health, financial situation and sense of security upside down. A committed Tampa motorcycle accidents lawyer helps even that score. We are investigating the accident, determining all responsible parties and creating a claim that is reflective of the actual cost of the injury.
              </p>
              <p>
                Our firm will obtain independent evidence and medical and accident reconstruction experts where appropriate, instead of relying on the insurance company's version of events. We negotiate from a position of strength.
              </p>
              <p>
                When a fair settlement is not offered, we prepare every case as though it will go to trial because that readiness is often what pushes an insurance company to take a claim seriously.
              </p>
            </div>
          </div>
