        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
            ...
            <p className="text-white/70 text-base md:text-[17px] leading-relaxed mb-8 font-medium">
              Do not face the insurance companies alone today and let our team fight for compensation. Contact a motorcycle accident lawyer Largo FL expert for help with your legal case today.
            </p>
