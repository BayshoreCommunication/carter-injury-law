  ...
  return (
    <section className="w-full bg-secondary py-16 text-white relative overflow-hidden">
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10 text-center">
        ...
        >
          Real advocacy is necessary for all injured riders because every client deserves a fighting chance at justice. We remain proud to secure justice for the victims of motorcycle accidents we represent.
        </motion.p>
