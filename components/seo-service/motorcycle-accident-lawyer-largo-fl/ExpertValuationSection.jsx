      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
            ...
            >
              How a Motorcycle Accident Lawyer Largo FL Turns Tragic Accidents <br />
            ...
            <div className="space-y-6 text-white/80 text-sm md:text-base leading-relaxed font-medium">
              <p>
                A serious motorcycle accident leaves victims facing overwhelming medical bills and lost income and long recovery. Insurance companies count on injured riders feeling too overwhelmed to fight lowball offers after crashes.
              </p>
              <p>
                Our reliable motorcycle accident lawyer Largo FL team holds negligent drivers accountable and pursues full compensation. We investigate every angle of your crash and gather strong evidence and negotiate for you.
              </p>
              <p>
                When insurance companies refuse a fair settlement we are prepared to take your case to trial.
              </p>
            </div>
          </div>
