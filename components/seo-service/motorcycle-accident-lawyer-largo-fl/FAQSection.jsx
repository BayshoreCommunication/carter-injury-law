...
const faqs = [
  {
    question: "Does Not Wearing a Helmet Prevent Me From Recovering Compensation in Florida?",
    answer:
      "Not wearing a helmet does not bar recovery but it may be used to argue negligence. This could reduce your total financial award amount so we fight to minimize this reduction. Your rights remain strong regardless of helmet use and we protect you from unfair blame.",
  },
  {
    question: "Can I Recover Damages if Another Driver Claimed They Never Saw My Motorcycle?",
    answer:
      "Yes a driver failure does not excuse them as they bear liability if negligence caused crashes. Our firm gathers evidence to prove their fault and we show they should have seen. You deserve compensation regardless of their weak excuses for hitting you on the road today. We show they should have seen the bike to hold them accountable now.",
  },
  {
    question: "What Types of Evidence Are Most Important in a Largo Motorcycle Accident Case?",
    answer:
      "Police reports and medical records are highly valuable along with photos of the scene and statements. Surveillance footage and expert reconstruction strengthen claims significantly and we combine these elements for results. You need strong proof for the best result so we gather all available evidence today.",
  },
];
