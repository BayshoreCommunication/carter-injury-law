...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "motorcycle-accident-lawyer-largo-fl").filePath,
  lawyerLeft = getSeoImage("carter.png", "motorcycle-accident-lawyer-largo-fl").filePath,
  
  titlePart1 = "Motorcycle Accident Lawyer Largo FL,",
  titlePart2 = "Legal Help for Injured Riders Across Pinellas County",
  subtitle = "A serious motorcycle crash shifts your world in a heartbeat leaving you with injuries and bills. You likely face mounting expenses while wondering what happens next during your difficult recovery process. Carter Injury Law fights for injured riders throughout Largo and Pinellas County for your rights. We work to secure the compensation you need to rebuild your life after your accident. Our motorcycle accident lawyer Largo FL team stands ready to advocate for your fair justice.",
}) => {
  return (
    <section 
