...
import { Phone, MapPin, Globe, Clock, ArrowRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 space-y-8 text-left">
            <div>
              ...
              <p className="text-gray-300 text-base sm:text-lg leading-relaxed font-medium">
                When an Accident Changes Your Life, Make Sure You Have the Right Legal Team in Your Corner. Call, share what happened, and let an experienced attorney take it from there.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-white/10">
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-white mt-0.5">801 W. Bay Dr., Suite 229, Largo, FL 33770 (By Appointment)</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-white mt-0.5">Largo: (727) 955-1922</p>
                  <p className="text-sm font-semibold text-white">Tampa: (813) 922-0228</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-white mt-0.5">Available 24 hours a day, 7 days a week.</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4">
              ...
              >
                <span>Call (727) 955-1922 Now</span>
          ...
          <div className="col-span-12 lg:col-span-5 relative">
            <div className="relative rounded-[24px] overflow-hidden shadow-2xl bg-slate-900 border border-white/10 h-[450px]">
              <Image
                src={getSeoImage("carter-team-cta.png", "pedestrian-accidents-lawyer-largo").filePath}
