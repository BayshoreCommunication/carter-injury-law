...
const FreeEvaluationCard = ({
  title = "Schedule Your Free, Confidential Largo Pedestrian Accident Case Evaluation Today",
  subtitle = "Talk to a Largo Pedestrian Accident Lawyer Before You Deal With the Insurance Company Call Carter Injury Law today.",
}) => {
