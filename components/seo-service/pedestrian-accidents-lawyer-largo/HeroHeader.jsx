...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "pedestrian-accidents-lawyer-largo").filePath,
  lawyerLeft = getSeoImage("carter.png", "pedestrian-accidents-lawyer-largo").filePath,
  
  titlePart1 = "Pedestrian Accidents Lawyer Largo,",
  titlePart2 = "Strong Advocacy for Injured Pedestrians",
  subtitle = "Nobody expects to be hit by a car while walking. A pedestrian crash can leave you facing serious injuries, mounting medical bills, and a long recovery. Once the driver's insurance company reaches out, you may also have to deal with questions about fault and the value of your claim. Carter Injury Law represents injured pedestrians throughout Largo and Pinellas County. If you are searching for a pedestrian accidents lawyer Largo, Attorney David Carter brings more than a decade of Florida personal injury experience and speaks directly with clients. We are available 24/7 for those who need legal guidance after a pedestrian accident.",
}) => {
  return (
    <section 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-stretch min-h-[520px] lg:min-h-[580px]">
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col justify-center pt-2 pb-10 lg:py-20 pr-0 lg:pr-10 order-2 lg:order-1">
            <div className="space-y-6">
              ...
              >
                Pedestrian Accidents Lawyer Largo
              </motion.span>
        ...
        >
          ...
          <div className="flex items-start gap-4 lg:px-6 hover:translate-x-1 transition-transform duration-300">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs sm:text-sm mt-1.5 leading-normal">
                Local lawyers. Local results. Serving Pinellas County.
              </p>
            </div>
          </div>
