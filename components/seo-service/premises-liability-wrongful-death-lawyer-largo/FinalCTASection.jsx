          ...
          <div className="col-span-12 lg:col-span-7 space-y-8 text-left">
            <div>
              ...
              <p className="text-gray-300 text-base sm:text-lg leading-relaxed font-medium">
                Carter Injury Law is ready to investigate what happened, document who is responsible, and pursue every dollar Florida law makes available to your family. Do not let the insurance company on the other side get any advantage.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-white/10">
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-white mt-0.5">801 W. Bay Dr., Suite 229, Largo, FL 33770</p>
                </div>
              </div>
