...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "premises-liability-wrongful-death-lawyer-largo").filePath,
  lawyerLeft = getSeoImage("carter.png", "premises-liability-wrongful-death-lawyer-largo").filePath,
  
  titlePart1 = "Premises Liability Wrongful Death Lawyer Largo,",
  titlePart2 = "Legal Support After a Preventable Property Death",
  subtitle = "If a property owner neglects to address a substantial safety risk that causes an accident that results in a death, the property owner may be legally liable. Premises Liability Wrongful Death Lawyer Largo, David Carter, is a highly experienced attorney who can help build a case against a negligent property owner or their insurance company and represent families in their wrongful death claims for over a decade. You and your family deserve to know the answers, have legal representation, and an attorney that will represent you and your interests.",
}) => {
  return (
    <section 
