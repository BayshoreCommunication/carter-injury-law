...
const FreeEvaluationCard = ({
  title = "Schedule Your Free, Confidential Largo Premises Liability Wrongful Death Case Evaluation Today",
  subtitle = "Fatal premises liability cases move faster than most families expect. We act fast to preserve surveillance footage and maintenance logs before property owners alter the accident scene.",
}) => {
