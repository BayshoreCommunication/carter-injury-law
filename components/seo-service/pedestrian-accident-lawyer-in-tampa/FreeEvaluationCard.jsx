...
const FreeEvaluationCard = ({
  title = "Schedule Your Free, Confidential Tampa Pedestrian Accident Case Evaluation Today",
  subtitle = "Get clear answers about your legal options and what your pedestrian accident claim may be worth.",
}) => {
