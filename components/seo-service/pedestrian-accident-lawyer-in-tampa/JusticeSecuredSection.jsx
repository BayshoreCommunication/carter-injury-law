      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-[42px] font-extrabold text-white tracking-tight leading-tight">
            Justice Secured for Tampa Pedestrian Accident Clients We Have Represented
          </h2>
          ...
          <p className="text-gray-300 text-lg sm:text-2xl leading-relaxed font-extrabold">
            See how careful preparation and dedicated representation have helped Tampa pedestrian accident clients pursue compensation.
          </p>
        </div>
