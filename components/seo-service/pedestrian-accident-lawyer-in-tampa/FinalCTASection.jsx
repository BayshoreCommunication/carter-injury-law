        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 space-y-8 text-left">
            <div>
              ...
              <p className="text-gray-300 text-base sm:text-lg leading-relaxed font-medium">
                Carter Injury Law offers a free, no-obligation case evaluation to anyone hurt in a pedestrian accident in Tampa or Hillsborough County. We will go through what happened, give you a straight answer about your legal options, and explain what the firm can realistically do for your situation.
              </p>
            </div>
          ...
          <div className="col-span-12 lg:col-span-5 relative">
            <div className="relative rounded-[24px] overflow-hidden shadow-2xl bg-slate-900 border border-white/10 h-[450px]">
              <Image
                src={getSeoImage("carter-team-cta.png", "pedestrian-accident-lawyer-in-tampa").filePath}
