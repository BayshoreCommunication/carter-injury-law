...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "pedestrian-accident-lawyer-in-tampa").filePath,
  lawyerLeft = getSeoImage("carter.png", "pedestrian-accident-lawyer-in-tampa").filePath,
  
  titlePart1 = "Pedestrian Accident Lawyer in Tampa:",
  titlePart2 = "Protection for Tampa Pedestrian Victims",
  subtitle = "When a pedestrian is injured in a traffic accident, the physical, financial, and legal consequences can be significant. Carter Injury Law handles exactly these situations. Attorney David Carter has spent over 10 years going to bat for people hurt by someone else's carelessness across Tampa and Hillsborough County. If a pedestrian accident lawyer in Tampa is what your situation calls for, Carter Injury Law is a good place to start that conversation.",
}) => {
  return (
    <section 
