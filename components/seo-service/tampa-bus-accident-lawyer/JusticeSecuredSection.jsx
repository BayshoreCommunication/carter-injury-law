  ...
  return (
    <section className="w-full bg-secondary py-16 text-white relative overflow-hidden">
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10 text-center">
        ...
        >
          Justice Secured for Tampa Bus Accident Victims We Have Represented
        </motion.h2>
        ...
        >
          Past results do not guarantee your outcome but reflect our professional standards of practice. We bring this level of commitment to every single case we accept here.
        </motion.p>
