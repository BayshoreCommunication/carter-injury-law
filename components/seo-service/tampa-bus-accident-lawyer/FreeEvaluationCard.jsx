...
const FreeEvaluationCard = ({ className = "" }) => {
  const [emailForm, setEmailForm] = useState({
    ...
    phone: "",
    email: "",
    message: "Free Consultation Request from Tampa Bus Accident Lawyer SEO Page",
  });
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <h3 className="text-xl md:text-[25px] font-extrabold text-secondary leading-tight pt-1">
                ...
                <span className="text-primary">Tampa Bus Accident Case Evaluation Today</span>
              </h3>
            </div>
            <p className="text-gray-600 text-xs sm:text-sm leading-relaxed font-medium">
              Evidence from a massive bus crash vanishes quickly without an immediate and aggressive investigation by professionals. Talk to a skilled bus accidents lawyer tampa before you sign any documents or speak to representatives.
            </p>
          </div>
          ...
          <form className="space-y-3" onSubmit={handleSubmit}>
            ...
            <div>
              {loading ? (
                <Button
                  isLoading
                  className="w-full bg-primary hover:bg-primary/95 text-white font-extrabold tracking-wide uppercase py-3 rounded-xl flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all duration-300"
                  size="md"
                >
                  Sending Request...
                </Button>
