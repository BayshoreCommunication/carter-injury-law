...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "tampa-wrongful-death-car-accident-lawyer").filePath,
  lawyerLeft = getSeoImage("carter.png", "tampa-wrongful-death-car-accident-lawyer").filePath,
