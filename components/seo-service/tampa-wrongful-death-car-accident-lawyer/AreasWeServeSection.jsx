...
import { MapPin, ArrowRight, Scale, ExternalLink, HelpCircle, Navigation } from "lucide-react";
          ...
          <div className="flex flex-col gap-5">
            {offices.map((office, i) => (
              <a
                ...
                className="group bg-white rounded-[20px] border border-gray-100 shadow-sm p-6 flex flex-col gap-4 hover:shadow-md hover:border-primary/20 transition-all duration-300 cursor-pointer"
              >
                {/* Card top row: label + external link icon */}
