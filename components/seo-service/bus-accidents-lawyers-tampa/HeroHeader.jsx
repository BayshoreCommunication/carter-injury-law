...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "bus-accidents-lawyers-tampa").filePath,
  lawyerLeft = getSeoImage("carter.png", "bus-accidents-lawyers-tampa").filePath,
  
  titlePart1 = "Bus Accidents Lawyer Tampa,",
  titlePart2 = "A Clear Path to Fair Compensation",
  subtitle = "A bus collision is significantly more severe than a standard traffic incident on our public roads. Large vehicles hitting your car usually cause injuries that require extensive medical care and long recovery. Our experienced bus accidents lawyer tampa gets moving immediately to track down whoever is responsible for harm. We push for every dollar Florida law allows to cover your mounting expenses and your trauma. You focus entirely on healing while we handle the complex legal details of your specific claim.",
}) => {
  return (
    <section 
