...
const features = [
  {
    number: "01",
    title: "Laser Focus on Complex Claims",
    body: "We focus deep resources on complex bus crash litigation and Commercial Motor Vehicle safety regulations.",
  },
  {
    number: "02",
    title: "Personalized Direct Oversight",
    body: "David Carter personally directs the investigation of every single case to ensure your claim receives rigorous review.",
  },
  {
    number: "03",
    title: "Relentless Advocacy & Results",
    body: "We bridge the gap between initial trauma and fair recovery through steadfast representation and constant communication.",
  },
];
    ...
    <section className="w-full bg-white py-0 overflow-hidden">
      <div className="max-w-[1320px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[580px]">
          ...
          >
            <Image
              src={getSeoImage("dedicated-counsel.png", "bus-accidents-lawyers-tampa").filePath} alt={getSeoImage("dedicated-counsel.png", "bus-accidents-lawyers-tampa").altText} title={getSeoImage("dedicated-counsel.png", "bus-accidents-lawyers-tampa").title}
              fill
          ...
          <div className="flex flex-col justify-center px-8 md:px-14 lg:px-16 py-14 lg:py-20 bg-[#faf9f6]">
            ...
            >
              Legal Counsel for Tampa Bus Accident Victims
            </motion.h2>
            ...
            >
              Carter Injury Law maintains a laser focus on complex injury claims throughout the Tampa Bay area. David Carter personally directs the investigation of every case to ensure your claim receives rigorous oversight. We recognize the profound physical and financial burdens that victims face after such traumatic events. You will always know who manages your legal strategy because we eliminate the confusing middleman process. Our bus accidents lawyer tampa team delivers relentless advocacy aimed at securing the results you deserve.
            </motion.p>
