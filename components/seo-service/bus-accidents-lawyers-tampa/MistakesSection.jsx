          ...
          >
            <div className="flex items-center gap-5 mb-8">
              <div className="relative w-24 h-24 shrink-0">
                <Image
                  src={getSeoImage("communication-mistakes.png", "bus-accidents-lawyers-tampa").filePath} alt={getSeoImage("communication-mistakes.png", "bus-accidents-lawyers-tampa").altText} title={getSeoImage("communication-mistakes.png", "bus-accidents-lawyers-tampa").title}
                  fill
          ...
          >
            <div>
              <div className="flex items-center gap-5 mb-8">
                <div className="relative w-24 h-24 shrink-0">
                  <Image
                    src={getSeoImage("evidence-timing.png", "bus-accidents-lawyers-tampa").filePath} alt={getSeoImage("evidence-timing.png", "bus-accidents-lawyers-tampa").altText} title={getSeoImage("evidence-timing.png", "bus-accidents-lawyers-tampa").title}
                    fill
                    className="object-contain"
                    sizes="96px"
                  />
