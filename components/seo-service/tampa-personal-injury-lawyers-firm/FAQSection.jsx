...
const faqs = [
  {
    ...
    answer:
      "There is no standard formula for calculating the specific value of your legal case. The worth depends on the severity of your injuries and the medical treatment. We evaluate every case individually and build a complete damages picture for you.",
  },
  {
    question: "How long does a personal injury case usually take?",
    answer:
      "Many cases resolve through negotiated settlement within several months to a year after filing. Cases that require a lawsuit take longer depending on court schedules and complexity. The timeline depends on how aggressively the opposing side contests the legal liability.",
  },
  {
    question: "What if I was partially responsible for the accident?",
    answer:
      "Florida modified comparative negligence law allows you to recover compensation if you are less than 50% responsible. Your total damages award is reduced by your assigned percentage of the fault. Our attorneys work to minimize any fault attributed to you in the case.",
  },
];
