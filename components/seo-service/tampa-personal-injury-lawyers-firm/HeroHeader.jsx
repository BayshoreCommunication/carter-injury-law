...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "tampa-personal-injury-lawyers-firm").filePath,
  lawyerLeft = getSeoImage("carter.png", "tampa-personal-injury-lawyers-firm").filePath,
  
  titlePart1 = "Tampa Personal Injury Lawyers Firm:",
  titlePart2 = "Committed to Your Recovery and Your Rights",
  subtitle = "A serious accident leaves you facing medical bills and physical pain that impacts your daily life. Insurance companies move fast to protect their own corporate interests instead of your best personal interests. You need a tampa personal injury lawyers firm that understands the challenges you are facing right now. Our legal team knows how to fight for every dollar that you are rightfully owed today. Carter Injury Law provides direct attorney access and aggressive legal advocacy for victims throughout Hillsborough County. David Carter brings over ten years of personal injury experience to every single case we accept.",
}) => {
  return (
    <section 
