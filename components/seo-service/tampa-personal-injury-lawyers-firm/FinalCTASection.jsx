      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
            ...
            >
              Secure Experienced Legal Representation <br />
              <span className="text-primary">Contact Carter Injury Law for a Confidential Consultation</span>
            </h2>
            ...
            <p className="text-white/70 text-base md:text-[17px] leading-relaxed mb-8 font-medium">
              You have enough to manage while recovering from an injury without adding the stress of a legal claim. Give us a call today for a free and private conversation about your path forward.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-white/10 max-w-xl">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">Office Address</p>
                  <p className="text-white font-semibold text-sm mt-0.5">3114 N Blvd, Tampa, FL 33603</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@carterinjurylaw.com" className="text-white font-semibold text-sm mt-0.5 hover:underline">
                    info@carterinjurylaw.com
                  </a>
                </div>
              </div>
            </div>
          ...
          {/* Right Column: Interactive Phone Numbers Card */}
          <div className="col-span-12 lg:col-span-5 relative flex items-center justify-center">
            ...
            >
              ...
              >
                ...
                <div>
                  <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Pinellas &amp; Pasco Office</p>
                  <p className="text-primary font-extrabold text-base sm:text-lg mt-0.5 group-hover:underline">
                    (727) 955-1922
                  </p>
                </div>
