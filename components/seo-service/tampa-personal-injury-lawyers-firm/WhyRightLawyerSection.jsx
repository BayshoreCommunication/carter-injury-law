    ...
    <section className="w-full grid grid-cols-1 lg:grid-cols-12 overflow-hidden bg-[#faf9f6]">
      ...
      >
        <div className="space-y-6 max-w-lg lg:max-w-none">
          ...
          >
            Why Injured Tampa Victims Lose Out on Compensation Without Legal Representation
          </h2>

          <div className="w-16 h-[3px] bg-primary mt-6 mb-6" />

          <p className="text-gray-600 text-sm md:text-base leading-relaxed font-medium">
            Insurance companies have teams and strategies. You deserve a legal team that's on your side. Here's the reality of what unrepresented victims face during an already difficult time.
          </p>
        </div>
          ...
          <motion.div variants={fadeInUp} className="flex gap-6 items-start">
            ...
            <div className="space-y-2 pt-1 flex-1">
              ...
              <p className="text-gray-600 text-sm md:text-[15px] leading-relaxed font-medium">
                Insurance adjusters are professionals whose primary objective is minimizing the amount of your claim payout today. They are trained to ask questions that elicit admissions and challenge your medical necessity treatment. What sounds like a routine conversation is actually a structured effort to limit financial exposure.
              </p>
            </div>
          </motion.div>
            ...
            <div className="space-y-2 pt-1 flex-1">
              <div className="flex items-center gap-3">
                ...
                <h3 
                  ...
                  style={{ fontFamily: 'Georgia, Cambria, "Times New Roman", Times, serif' }}
                >
                  The Risk of Accepting an Early Settlement Offer
                </h3>
              </div>
              <p className="text-gray-600 text-sm md:text-[15px] leading-relaxed font-medium">
                Insurance companies routinely extend settlement offers within days before you know your medical needs entirely. These early offers are almost always below the true value of your injury claim here. They are designed to close the file cheaply before future treatment costs are fully documented.
              </p>
            </div>
          </motion.div>
            ...
            <div className="space-y-2 pt-1 flex-1">
              <div className="flex items-center gap-3">
                ...
                <h3 
                  ...
                  style={{ fontFamily: 'Georgia, Cambria, "Times New Roman", Times, serif' }}
                >
                  The Cost of Handling Your Injury Claim Alone
                </h3>
              </div>
              <p className="text-gray-600 text-sm md:text-[15px] leading-relaxed font-medium">
                Unrepresented victims consistently recover less money than those who hire qualified legal counsel for help. Attorneys understand how to document damages and counter insurer tactics to produce stronger results effectively. Going it alone against a well resourced insurance company directly affects the outcome of your case.
              </p>
            </div>
          </motion.div>
