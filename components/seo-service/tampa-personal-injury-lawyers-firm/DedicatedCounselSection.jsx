...
const features = [
  {
    ...
    body: "Injured clients deserve to work directly with the attorney handling their case file. We do not pass you to staff or leave you without answers today ever.",
  },
  {
    number: "02",
    title: "Personalized Client Relationships",
    body: "David Carter maintains direct relationships with every client he represents daily. You call with a question and you hear back from your attorney directly today.",
  },
  {
    number: "03",
    title: "Reliable Personal Contacts",
    body: "We maintain transparent lines of communication throughout your entire recovery, ensuring you always know the status of your claim.",
  },
];
      ...
      <div className="max-w-[1320px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[580px]">
          ...
          <div className="flex flex-col justify-center px-8 md:px-14 lg:px-16 py-14 lg:py-20 bg-[#faf9f6]">
            ...
            >
              Dedicated Legal Counsel for Injured Victims Throughout Tampa
            </motion.h2>
