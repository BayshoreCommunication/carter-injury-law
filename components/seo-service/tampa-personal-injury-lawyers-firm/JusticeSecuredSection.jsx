  ...
  return (
    <section className="w-full bg-secondary py-16 text-white relative overflow-hidden">
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10 text-center">
        ...
        >
          Justice Secured for Tampa Injury Victims We Have Represented
        </motion.h2>
        ...
        >
          Carter Injury Law helps clients recover meaningful compensation when insurance companies offer less money.
        </motion.p>
