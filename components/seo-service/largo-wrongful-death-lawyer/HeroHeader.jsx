...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "largo-wrongful-death-lawyer").filePath,
  lawyerLeft = getSeoImage("carter.png", "largo-wrongful-death-lawyer").filePath,
  
  titlePart1 = "Largo Wrongful Death Lawyer,",
  titlePart2 = "Justice After a Preventable Death",
  subtitle = "The sudden loss of a family member in a preventable accident changes your entire future instantly. You need a committed Largo wrongful death lawyer to stand by your side during this time. Carter Injury Law provides aggressive legal representation to families seeking the accountability they rightfully deserve now. We remove the heavy burden of the legal process so you can focus on healing. Our team investigates every detail to secure the maximum compensation for your tragic and sudden loss.",
}) => {
  return (
    <section 
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col justify-center pt-2 pb-10 lg:py-20 pr-0 lg:pr-10 order-2 lg:order-1">
            <div className="space-y-6">
              ...
              <motion.h1 
                ...
                className="text-4xl sm:text-5xl lg:text-6xl xl:text-[54px] font-extrabold text-white lg:text-secondary leading-[1.1] tracking-tight"
              >
                {titlePart1} <br />
        ...
        >
          ...
          <div className="flex items-start gap-4 lg:px-6 hover:translate-x-1 transition-transform duration-300">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs sm:text-sm mt-1.5 leading-normal">
                Local lawyers. Local results. Proudly serving Largo Bay.
              </p>
            </div>
          </div>
