...
const steps = [
  {
    ...
    body: "We reconstruct the crash, bringing in accident specialists to map the precise path of the collision and demonstrate exactly where safety protocols failed.",
    bullets: null,
  },
  {
    number: "02",
    ...
    body: "We meticulously examine and collect every piece of electronic data, signal timing logs, traffic reports, and witness statements before they disappear.",
    bullets: null,
  },
  {
    number: "03",
    ...
    body: "From drivers to corporate truck carriers, fleet maintenance logs, or municipal roadway planners, we trace liability to identify corporate and individual negligence.",
    bullets: null,
  },
  {
    number: "04",
    icon: Calculator,
    title: "Calculate Full Loss",
    body: "We calculate both financial and emotional damages: final medical care bills, lost prospective earnings, household services, and loss of guidance.",
    bullets: null,
  },
  {
    number: "05",
    ...
    body: "We package all evidence into a comprehensive demand. If the insurer refuses a fair settlement, our trial preparation serves as the backbone to litigate.",
    bullets: null,
  },
];
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-secondary leading-[1.15] tracking-tight">
            How a Largo Wrongful Death Lawyer <br />
          ...
          <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-3xl mx-auto font-medium">
            We meticulously examine every piece of electronic data and witness accounts to establish a chain of liability. Our legal team maps the precise path of the collision to demonstrate exactly where safety protocols failed. We link those failures directly to your loss to build your claim.
          </p>
        </motion.div>
              ...
              <motion.div key={idx} variants={fadeInUp} className="flex flex-col items-center w-full">
                <div className="flex items-start gap-4 w-full">
                  ...
                  <div className="flex-1 bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-4 mb-2 hover:shadow-md transition-shadow duration-300">
                    ...
                    <p className="text-gray-500 text-xs leading-relaxed font-medium">{step.body}</p>
                  </div>
                </div>
