...
const steps = [
  {
    number: "01",
    icon: Scroll,
    title: "Clarifying the Estate's Role in a Wrongful Death Case",
    body: "The law requires the appointment of a personal representative to lead the legal claim for you. This representative acts on behalf of the estate and the surviving family members throughout the process. We assist you in managing the probate requirements to ensure the lawsuit proceeds without any delay.",
  },
  {
    number: "02",
    icon: Heart,
    title: "Eligible Family Members Under Florida Law",
    body: "Surviving spouses and children usually hold the right to seek compensation for their tragic personal loss. Parents of minor children also have clear legal standing to pursue damages under the state law. We determine which specific family members qualify for recovery to maximize the total claim value.",
  },
  {
    number: "03",
    icon: GraduationCap,
    title: "When Financial Dependence Affects Recovery Rights",
    body: "Adult children or other relatives may recover damages if they relied on the deceased for support. We review your family finances to prove the level of dependence you held on your loved one. This documentation is essential for including every deserving family member in the successful legal claim.",
  },
  {
    number: "04",
    icon: Home,
    title: "Resolving Family Disputes Over Legal Standing",
    body: "Disagreements about who represents the estate can create unnecessary stress and conflict during your grieving process. We mediate these issues and provide the legal guidance needed to unify your family approach. Clear leadership allows us to focus entirely on winning the case against the responsible party.",
  },
];
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8">
        ...
        >
          ...
          <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-3xl mx-auto font-medium">
            Florida law strictly defines the individuals who have the legal standing to pursue a wrongful death. We assess your unique family situation to confirm your eligibility under the relevant Florida state statutes.
          </p>
        </motion.div>
