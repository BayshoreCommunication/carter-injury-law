  ...
  return (
    <section className="w-full bg-secondary py-16 text-white relative overflow-hidden">
      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8 relative z-10 text-center">
        ...
        >
          Justice Secured for Largo Bus Accident Victims We Have Represented
        </motion.h2>
        ...
        >
          Real clients have trusted our firm to fight for their recovery following their bus crashes. Their results reflect our commitment to clear communication and dedicated legal work for everyone.
        </motion.p>
