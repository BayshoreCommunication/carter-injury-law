        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
            ...
            <p className="text-white/70 text-base md:text-[17px] leading-relaxed mb-8 font-medium">
              Reach out today for your free, confidential consultation with our legal experts. Do not face a claim alone when experienced advocacy is a call away. Call Carter Injury Law at (727) 955-1922 for Pinellas County or (813) 922-0228 for our office. Visit our Largo office at 801 W. Bay Dr., Suite 229, Largo, FL 33770. Our main office is located at 3114 N. Boulevard, Tampa, FL 33603.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-white/10 max-w-xl">
              ...
              <div className="flex gap-3">
                <MapPin className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">Tampa Main Office</p>
          ...
          <div className="col-span-12 lg:col-span-5 relative flex items-center justify-center">
            ...
            >
              ...
              >
                ...
                <div>
                  <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Pinellas County Office</p>
