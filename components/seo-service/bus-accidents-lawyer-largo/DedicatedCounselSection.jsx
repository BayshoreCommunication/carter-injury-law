      ...
      <div className="max-w-[1320px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[580px]">
          ...
          <div className="flex flex-col justify-center px-8 md:px-14 lg:px-16 py-14 lg:py-20 bg-[#faf9f6]">
            ...
            >
              Dedicated Legal Counsel for Largo Bus Accident Victims
            </motion.h2>
            ...
            >
              Carter Injury Law provides dedicated legal counsel to victims throughout Largo for all accident cases. Our bus accidents lawyer Largo team represents victims suffering from soft tissue trauma, whiplash, and bone fractures. We treat every client like family and remain available to answer any questions you have. Our attorneys handle all communication with insurance companies so you can focus on your healing. Clients receive honest, direct, and transparent legal guidance throughout the entire process. We prepare every case as if it were headed to trial to ensure readiness.
            </motion.p>
