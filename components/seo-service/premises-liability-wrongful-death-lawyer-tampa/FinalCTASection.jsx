        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 space-y-8 text-left">
            <div>
              ...
              <p className="text-gray-300 text-base sm:text-lg leading-relaxed font-medium">
                What your family is dealing with right now is not something you should be managing without legal guidance. Carter Injury Law is available around the clock, and there is no cost and no obligation attached to the first conversation.
              </p>
            </div>
          ...
          <div className="col-span-12 lg:col-span-5 relative">
            <div className="relative rounded-[24px] overflow-hidden shadow-2xl bg-slate-900 border border-white/10 h-[450px]">
              <Image
                src={getSeoImage("carter-team-cta.png", "premises-liability-wrongful-death-lawyer-tampa").filePath}
