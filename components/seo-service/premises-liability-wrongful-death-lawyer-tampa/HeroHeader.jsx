...
const HeroHeader = ({
  bgImage = getSeoImage("hero-bg.png", "premises-liability-wrongful-death-lawyer-tampa").filePath,
  lawyerLeft = getSeoImage("carter.png", "premises-liability-wrongful-death-lawyer-tampa").filePath,
  
  titlePart1 = "Premises Liability Wrongful Death Lawyer Tampa,",
  titlePart2 = "Accountability for Negligent Property Owners",
  subtitle = "Some losses don't make sense no matter how long you sit with them. When a loved one dies because of the negligence of a property owner, the grief your family carries shouldn't come with a financial crisis attached to it. Attorney David Carter is the premises liability wrongful death lawyer Tampa, has spent over 10 years representing seriously injured clients and surviving families across Tampa and Hillsborough County. When you're faced with serious legal cases, you should have a lawyer on your side who can provide you with the advice and guidance you need and deserve.",
}) => {
  return (
    <section 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-stretch min-h-[520px] lg:min-h-[580px]">
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col justify-center pt-2 pb-10 lg:py-20 pr-0 lg:pr-10 order-2 lg:order-1">
            <div className="space-y-6">
              ...
              >
                Premises Liability Wrongful Death Lawyer Tampa
              </motion.span>
              ...
              <motion.h1 
                ...
                className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl xl:text-[50px] font-extrabold text-white lg:text-secondary leading-[1.1] tracking-tight animate-none break-words"
              >
                {titlePart1} <br />
        ...
        >
          ...
          <div className="flex items-start gap-4 lg:px-6 hover:translate-x-1 transition-transform duration-300">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs sm:text-sm mt-1.5 leading-normal">
                Local lawyers. Local results. Serving Tampa Bay.
              </p>
            </div>
          </div>
