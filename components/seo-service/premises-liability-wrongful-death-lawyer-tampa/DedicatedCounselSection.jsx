      ...
      <div className="max-w-[1320px] mx-auto w-full px-4 sm:px-6 md:px-8">
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 text-center space-y-6">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-[40px] font-extrabold text-secondary tracking-tight leading-tight">
            Dedicated Legal Counsel for Tampa Families Facing Premises Liability Wrongful Death Claims
          </h2>
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed font-medium text-left md:text-center">
            When a family retains Carter Injury Law, they retain the premises liability wrongful death lawyer tampa who will personally handle their case from the first call to the final resolution. David Carter is not a name on the door who hands things off once the paperwork is signed. He builds the legal strategy, stays in direct contact throughout, and is available to answer questions without a case manager as the go-between. Every strategy is built around that particular family's loss, that specific property, and the full scope of what the survivors have actually gone through. No family should have to worry about legal fees while they're trying to put their lives back together. Carter Injury Law advances all case expenses and earns a fee only if the firm recovers compensation on the family's behalf. The contingency arrangement isn't just a billing arrangement. It's a commitment that the firm's interests are fully aligned with the family's from the beginning.
          </p>
