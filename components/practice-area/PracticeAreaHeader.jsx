...
const PracticeAreaHeader = () => {
  return (
    <div className="relative">
      ...
      {/* <div className="hidden lg:block absolute w-full max-w-[530px] -bottom-[22%] right-[11%] bg-white rounded-[22px] pt-5">
      ...
      <HeaderForm className={"absolute -bottom-[11%] right-[11%] bg-white"} />
    </div>
  );
};
