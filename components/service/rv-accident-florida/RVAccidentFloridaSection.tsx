...
export default function RVAccidentFloridaSection() {
  return (
    <div className="min-h-screen py-8 px-4 md:px-8">
      <div className="max-w-5xl mx-auto space-y-10 text-slate-600 leading-relaxed">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Showing that your lights and equipment were in full working order.
          </li>
        </ul>
        ...
        <p>
          ...
          look for evidence of mechanical failure, such as a faulty brake line
          or a blown tire that was poorly manufactured. By building a case based
          on hard evidence, we make it much harder for the defense to win with
          empty excuses.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            We look for dashcam footage from other drivers who were in the area.
          </li>
        </ul>
        ...
        <p>
          ...
          deserve compensation. We work with mental health professionals to
          document the psychological trauma of the collision. Our firm is
          dedicated to the person as a whole, not just the repair bill for the
          vehicle.
        </p>

        <h3 className="text-xl font-semibold text-slate-800">
          Recover from significant financial trauma
        </h3>

        <ul className="list-disc pl-6 space-y-2">
          <li>
            Equity Protection. We fight to get you enough money to buy a similar
            vehicle.
          </li>
          <li>Pursuing funds for the time you spent dealing with the crash.</li>
          <li>
            Ensuring every hospital visit is paid for by the at-fault party.
          </li>
          <li>Securing the funds needed for any permanent disabilities.</li>
        </ul>
