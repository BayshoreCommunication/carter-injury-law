...
export default function TampaPedestrianAccidentLawyerPage2() {
  return (
      ...
      <div className="max-w-[1320px] mx-auto w-full">
        ...
        <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
          <h2 className="text-2xl font-bold text-slate-800 pt-4">
            Why Does an Auto Pedestrian Accident Often Result in Catastrophic
            Harm?
          </h2>
          ...
          <p className="text-sm md:text-lg">
            ...
            data shows they weren't looking.
          </p>
          ...
          <p className="text-sm md:text-lg">
            ...
            compensates you for the loss of your cognitive health.
          </p>
