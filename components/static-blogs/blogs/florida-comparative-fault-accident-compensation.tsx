        ...
        <div className="grid gap-0 md:grid-cols-[1.15fr_.85fr]">
          ...
          <figure className="relative min-h-[320px]">
            <Image
              src={featuredImage}
              alt={
                floridaComparativeFaultAccidentCompensation.featuredImage
                  .altText
              }
              title={
                floridaComparativeFaultAccidentCompensation.featuredImage.title
              }
              fill
            ...
            <figcaption className="absolute inset-x-0 bottom-0 bg-black/70 !px-4 !py-3 text-sm text-white">
              {floridaComparativeFaultAccidentCompensation.featuredImage.caption}
            </figcaption>
          </figure>
        </div>
      </div>
